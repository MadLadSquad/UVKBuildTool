...
void UBT::generateGame(const char* name)
{
    ...
    UTG::Input in;
    auto result = in.init("../Templates/BuildFiles/Game.hpp.tmpl", UTG::Input::INPUT_TYPE_FILE);
...
void UBT::generateMain(const char* startupLevelName, const char* gameName)
{
    {
        UTG::Input in;
        auto result = in.init("../Templates/Sources/main.cpp.tmpl", UTG::Input::INPUT_TYPE_FILE);
        if (result != UTG::Input::ERROR_TYPE_NO_ERROR)
        {
    ...
    UTG::Input in;
    auto result = in.init("../Templates/Sources/mainmodded.cpp.tmpl", UTG::Input::INPUT_TYPE_FILE);
    if (result != UTG::Input::ERROR_TYPE_NO_ERROR)
    {
...
{
    std::filesystem::copy_file("../Templates/Sources/Wrapper.hpp.tmpl", path + "WrapperSource/Wrapper.hpp");
    std::filesystem::copy_file("../Templates/Sources/Wrapper.cpp.tmpl", path + "WrapperSource/Wrapper.cpp");
    std::filesystem::copy_file("../Templates/Sources/ModEmpty.hpp.tmpl", path + "Generated/ModEmpty.hpp");
    std::filesystem::copy_file("../Templates/Sources/ModEmpty.cpp.tmpl", path + "Generated/ModEmpty.cpp");
}
